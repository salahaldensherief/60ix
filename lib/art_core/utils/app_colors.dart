...
class AppColors {
  ...
  static const Color scaffoldDarkColor = Color(0xff0D0D12);
  static const Color secondaryBtnColor = Color(0xffFDEBE8);
  ...
  static const Color appBarDarkColor = Color(0xffE8E8E9);
  static const Color textColorLightPrimary = Color(0xff1F1F1F);
  static const Color textColorDarkPrimary = Color(0xff1D1D28);
  static const Color textColorLightSecondary = Color(0xff727272);
  static const Color textColorDarkSecondary = Color(0xffB7B7BA);
